			 ...
			 CompetitorList dancerList = new CompetitorList();
                  ...
                  for (Competitor c : compList.getcompetitorList()) {
				   if (c instanceof Dancer){
				  	...
				  	resultList.setText(dancerList.getCompetitorList());
		}
			 ...
			 CompetitorList gamerList = new CompetitorList();
                 ...
                 for (Competitor c : compList.getcompetitorList()) {
				   if (c instanceof Gamer){
				  	...
				  	resultList.setText(gamerList.getCompetitorList());
		}
			 ...
			 CompetitorList knitterList = new CompetitorList();
                ...
                for (Competitor c : compList.getcompetitorList()) {
				   if (c instanceof Knitter){
				  	...
				  	resultList.setText(knitterList.getCompetitorList());
		}
				 ...
				 CompetitorList dancerList = new CompetitorList();
	                  ...
	                  for (Competitor c : compList.getcompetitorList()) {
					   if (c instanceof Dancer){
					  	...
					  	resultList.setText(dancerList.listByName());
			}
		 	else if (competitionSelected == "Gaming") {
				 ...
				 CompetitorList gamerList = new CompetitorList();
	                 ...
	                 for (Competitor c : compList.getcompetitorList()) {
					   if (c instanceof Gamer){
					  	...
					  	resultList.setText(gamerList.listByName());
			}
			else if (competitionSelected == "Knitting") {
				 ...
				 CompetitorList knitterList = new CompetitorList();
	                ...
	                for (Competitor c : compList.getcompetitorList()) {
					   if (c instanceof Knitter){
					  	...
					  	resultList.setText(knitterList.listByName());
			}
				 ...
				 CompetitorList dancerList = new CompetitorList();
	                  ...
	                  for (Competitor c : compList.getcompetitorList()) {
					   if (c instanceof Dancer){
					  	...
					  	resultList.setText(dancerList.listByID());
			}
		 	else if (competitionSelected == "Gaming") {
				 ...
				 CompetitorList gamerList = new CompetitorList();
	                 ...
	                 for (Competitor c : compList.getcompetitorList()) {
					   if (c instanceof Gamer){
					  	...
					  	resultList.setText(gamerList.listByID());
			}
			else if (competitionSelected == "Knitting") {
				 ...
				 CompetitorList knitterList = new CompetitorList();
	                ...
	                for (Competitor c : compList.getcompetitorList()) {
					   if (c instanceof Knitter){
					  	...
					  	resultList.setText(knitterList.listByID());
			}
			 else
				 resultList.setText("not found");
	 }
